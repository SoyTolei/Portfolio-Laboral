...
const translations = {
    es: {
        ...
        proj_sbbackup_title: 'ST2 — Backup, Restore y Queries',
        proj_sbbackup_p1: 'Suite de mantenimiento para sistemas Bejerman: detección automática de bases por empresa, backups y restauración con vista previa de metadatos, y un ejecutor de scripts SQL con consultas frecuentes, backup de seguridad automático antes de modificar datos y explicación del script en lenguaje simple antes de correrlo, vía IA.',
    ...
    en: {
        ...
        proj_sbbackup_title: 'ST2 — Backup, Restore & Queries',
        proj_sbbackup_p1: 'Maintenance suite for Bejerman systems: automatic per-company database detection, backups and restore with metadata preview, plus a SQL script runner with frequent queries, automatic safety backup before any data change, and a plain-language AI explanation of a script before running it.',
