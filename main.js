...
const translations = {
    es: {
        ...
        proj_st2web_p1: 'Portal del agente en el navegador: planillas (transferencia, referral I+D, oportunidad), blanqueo de accesos, generador de PDFs A4, Portal Cliente, THOM, AI Platform y panel de accesos por usuario.',
    ...
    en: {
        ...
        proj_st2web_tag_portal: 'Portal',
        proj_st2web_p1: 'Agent portal in the browser: case sheets (transfers, R&D referrals, sales opportunities), access wipe requests, A4 PDF generator, Portal Cliente, THOM, AI Platform and per-user access admin.',
