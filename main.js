...
const translations = {
    es: {
        ...
        about_p3: '<strong>ST2</strong> (Soluciones Tecnológicas) es una suite interna en <strong>C# / .NET</strong> y PowerShell — aplicación web, herramientas SQL y consola de campo — orientada a estandarizar tareas recurrentes de soporte.',
        st2_disclaimer: 'Las herramientas ST2 no representan productos ni posiciones oficiales de Thomson Reuters.',
        note_label: '// enfoque',
        note_body: 'Herramientas de uso compartido y procedimientos consistentes, en lugar de conocimiento que queda en una sola persona. ST2 cubre planillas, backups y diagnóstico de instalaciones.',
        exp_eyebrow: '// carrera',
        ...
        projects_lead: 'Herramientas de soporte y un proyecto personal. <strong>ST2</strong> es una iniciativa interna, no un producto de Thomson Reuters.',
    ...
    en: {
        ...
        about_p3: '<strong>ST2</strong> (Technical Solutions) is an internal suite in <strong>C# / .NET</strong> and PowerShell — web app, SQL tools and a field console — built to standardise recurring support tasks.',
        st2_disclaimer: 'ST2 tools do not represent official Thomson Reuters products or positions.',
        note_label: '// approach',
        note_body: 'Shared tools and consistent procedures, rather than knowledge that stays with one person. ST2 covers case sheets, backups and install diagnostics.',
        exp_eyebrow: '// career',
        exp_title: 'Career',
        exp_present: 'now',
        ...
        projects_lead: 'Support tools and a personal project. <strong>ST2</strong> is an internal initiative, not a Thomson Reuters product.',
